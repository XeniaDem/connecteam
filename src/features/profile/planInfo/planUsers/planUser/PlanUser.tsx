...
export function PlanUser({ planId, planUser, onChange }: Props) {
  ...
  return (
    <div className={styles.background}>
      ...
      {removeUserOpen ? <RemoveUserPopup planUser={planUser} planId = {planId} closePopup={closeRemoveUserPopup} onChange={onChange} /> : null}
    </div>
  )
}
